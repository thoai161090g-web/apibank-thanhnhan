...
# ==========================================
# CẤU HÌNH FLASK WEBHOOK (THUEAPI)
# ==========================================
...
# === THAY SECRET KEY CỦA BẠN VÀO ĐÂY ===
...
# ==========================================
def process_deposit(user_id, amount, va="", trans_id=""):
    """Xử lý nạp tiền từ webhook ThueAPI"""
    try:
        user = get_user(user_id)
        if user is None:
    ...
    try:
        ...
        if 'NAP' in content:
            ...
            if match:
                ...
                trans_id = data.get('id', f"VA-{va}")
                process_deposit(user_id, amount, va, trans_id)
            else:
